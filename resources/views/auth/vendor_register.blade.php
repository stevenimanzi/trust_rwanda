...
@section('title', 'Vendor Registration - Trust Rwanda')
    ...
    <div class="login-card">
        <div class="login-left">
            <svg viewBox="0 0 400 300" width="100%" height="auto" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Vendor Icon -->
                <path d="M170 120 L230 120 L220 140 L180 140 Z" fill="#c4d2e8" />
                <rect x="185" y="125" width="30" height="10" rx="2" fill="#1a428a" />
        ...
        <div class="login-right">
            <h1 class="login-heading">VENDOR SIGN UP</h1>
            <p class="login-subheading">Launch your shop and reach thousands of buyers.</p>
            ...
            <form method="POST" action="{{ route('vendor.register') }}">
                ...
                <div class="form-row">
                    <div class="form-col">
                        <div class="form-group">
                            <label class="form-label" for="ownerInput">Owner Name</label>
                    ...
                    <div class="form-col">
                        <div class="form-group">
                            <label class="form-label" for="shopInput">Shop Name</label>
                            <div class="input-wrapper">
                                <input type="text" name="shop_name" id="shopInput" class="input-field" placeholder="Shop Name" value="{{ old('shop_name') }}" required>
                ...
                <div class="form-group">
                    <label class="form-label" for="addrInput">Physical Address</label>
                    <div class="input-wrapper">
                ...
                <div class="form-row">
                    ...
                    <div class="form-col">
                        <label class="form-label">Pin Shop Location</label>
                        <div id="regMap"></div>
                ...
                <button type="submit" class="login-btn">LAUNCH MY SHOP</button>
...
function initMap() {
    try {
        ...
        console.error('Registration map initialization failed:', error);
        const mapEl = document.getElementById('regMap');
        if (mapEl) {
            mapEl.innerHTML = '<div class="text-center p-4"><i class="bi bi-exclamation-triangle-fill text-warning"></i><p class="small mt-1">Map display error.</p></div>';
        }
    }
}
    ...
    if (toggleBtn) {
        toggleBtn.addEventListener('click', function() {
            ...
            const redrawInterval = setInterval(() => {
                map.invalidateSize();
                ticks++;
                if (ticks > 15) clearInterval(redrawInterval);
            }, 30);
