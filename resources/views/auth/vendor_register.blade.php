...
<div class="tr-login-wrapper">
    <div class="tr-login-container">
        ...
        <h1 class="tr-title">Vendor Sign Up</h1>
        <p class="tr-subtitle">Launch your shop and reach thousands of buyers.</p>
        ...
        <form method="POST" action="{{ route('vendor.register') }}">
            ...
            <div class="tr-form-row">
                <div class="tr-form-col">
                    <div class="tr-form-group">
                        <label class="tr-form-label" for="ownerInput">Owner Name</label>
                ...
                <div class="tr-form-col">
                    <div class="tr-form-group">
                        <label class="tr-form-label" for="shopInput">Shop Name</label>
                        <div class="tr-input-wrapper">
                            <input type="text" name="shop_name" id="shopInput" class="tr-form-control" placeholder="Shop Name" value="{{ old('shop_name') }}" required>
                            <i class="bi bi-shop tr-icon"></i>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="tr-form-group">
                <label class="tr-form-label" for="addrInput">Physical Address</label>
                <div class="tr-input-wrapper">
            ...
            <div class="tr-form-row">
                ...
                <div class="tr-form-col">
                    <label class="tr-form-label">Pin Shop Location</label>
            ...
            <button type="submit" class="tr-btn-submit mt-4">
                LAUNCH MY SHOP <i class="bi bi-rocket-takeoff ms-1"></i>
            </button>
